...
### Análise:
* Análise exploratória utilizando Python se encontra no diretório `pandas_analises`
* Análise exploratória utilizando R se encontra no diretório `r_analises`
...
-----------
### Apresentações:
* [RPubs](https://rpubs.com/naanadr/violencia-mulher-recife)
